...
![1](https://doc.shiyanlou.com/linux_base/7-2.png/wm)
...
![此处输入图片的描述](https://doc.shiyanlou.com/document-uid735639labid62timestamp1532339776332.png/wm)
...
![此处输入图片的描述](https://doc.shiyanlou.com/document-uid735639labid62timestamp1532339755321.png/wm)
...
![此处输入图片的描述](https://doc.shiyanlou.com/document-uid735639labid62timestamp1532339693208.png/wm)
...
![1](https://doc.shiyanlou.com/linux_base/7-12.png/wm)
...
![1](https://doc.shiyanlou.com/linux_base/7-13.png/wm)

在进行操作前我们首先应先规划好我们的分区方案，这里我将在使用 128M（可用 127M 左右）的虚拟磁盘镜像创建一个 30M 的主分区剩余部分为扩展分区包含 2 个大约 45M 的逻辑分区。

操作完成后输入 `p` 查看结果如下:

![1](https://doc.shiyanlou.com/linux_base/7-14.png/wm)
...
![pic](https://doc.shiyanlou.com/linux_base/7-15.png/wm)
...
![pic](https://doc.shiyanlou.com/linux_base/7-16.png/wm)
...
![此处输入图片的描述](https://doc.shiyanlou.com/document-uid735639labid62timestamp1532339794389.png/wm)
