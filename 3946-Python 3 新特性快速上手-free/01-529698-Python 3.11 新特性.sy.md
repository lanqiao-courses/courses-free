...
Python 3.11 预计在 2022 年 10 月 3 日发布，本次版本更新主要对错误提示、异常处理和类型系统进行了提升。
...
可以发现，箭头所示的位置，有一点突出的指示，让我们可以更容易的发型问题。相比来说，Python 3.8 只是告诉我们一个键 'd' 写错了，但我们写了两个 'd'，还得自己判断，有点麻烦。
